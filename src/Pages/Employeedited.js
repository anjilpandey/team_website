    ...
    <>
      <div className='sidebar3'>
            ...
            <div className='contentemp'>
                ...
                <div className='ndown'>
                    Manage Users <img src='./image/Group 19460.jpg' height='16px' width='16px'></img> Employees <img src='./image/Group 19460.jpg' height='16px' width='16px'></img> Edit Employee
                </div>
                <h1 className='ateam'>Edit Employee</h1>

                <div className='mainbox2'>
                    <div className='profilepicture'>
                        <div style={{position:"relative"}}><img src='./image/Ellipse 334.png' width='120px' height='120px'></img>
                        <div style={{position:"absolute",right:"0px",bottom:"10px",background:"#20BC08",borderRadius:"30px",width:"30px",height:"30px",border:"3px solid white"}}><img style={{width:"23px",paddingLeft:"5px",paddingTop:"3px"}} src='./image/filter (3).png'></img></div>
                        </div>
                        <div className='pbdisplay'>
                            <div className='pimagetext'>Chadwick Boseman</div>
                            <h5 style={{color:"grey",fontFamily:"sans-serif"}}>chad@gmail.com</h5>
                            <div>
                                <button className='pi_button1'>
                                    <div className='pp'>Super Admin</div>
                                </button>
                            </div>
                        </div>
